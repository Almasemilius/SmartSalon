                        ...
                        <div class="flex flex-wrap pt-4">
                            <div class="w-full lg:w-6/12 px-4">
                                <div class="relative w-full mb-3">
                                    ...
                                    <input wire:model.defer="service.name" type="text" class="border-0 px-3 py-3 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" id="serviceName">
                                </div>
                            </div>
                            <div class="w-full lg:w-6/12 px-4">
                                <div class="relative w-full mb-3">
                                    ...
                                    <input wire:model.defer="service.price" type="number" class="border-0 px-3 py-3 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" id="servicePrice">
                                </div>
                            </div>
                            <div class="w-full px-4">
                                <div class="relative w-full mb-3">
                                    ...
                                    <textarea wire:model.defer="service.info" id="serviceInfo" type="textarea" class="border-0 px-3 py-3 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"></textarea>
                                </div>
                            </div>
                            <div class="lg:w-6/12 px-4">
                                <div class="relative w-full mb-3">
                                    ...
                                    <label class="w-64 flex flex-col items-center px-4 py-1 rounded-lg shadow-lg tracking-wide uppercase cursor-pointer bg-brownish">
                                        ...
                                        <input wire:model.defer="service.image" type='file' class="hidden" />
                                    </label>
                                </div>
                            </div>
                            <div class="lg:w-6/12 px-4">
                                ...
                                <div class="relative mb-3  text-center">
                                    <button wire:click.prevent="addService" class="w-64 shadow-lg bg-brownish rounded-md px-4 py-6">Add Service</button>
                                </div>
                            </div>
                        </div>
                        {{-- Our Services Ends --}}
                        ...
                        <div class="h-44 overflow-y-scroll mb-4">
                            ...
                            <div class="">
                                <div class="grid grid-cols-1 sm:grid-cols-6 md:grid-cols-6 lg:grid-cols-6 xl:grid-cols-6 gap-4">
                                    ...
                                    <div class="col-span-2 sm:col-span-1 xl:col-span-1 italic font-semibold">Tsh. {{number_format($service->price)}} /=</div>
